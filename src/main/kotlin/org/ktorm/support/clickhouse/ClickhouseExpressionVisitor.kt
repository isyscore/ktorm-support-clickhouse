...
/**
 * Base interface designed to visit or modify Clickhouse expression trees using visitor pattern.
 *
 * For detailed documents, see [SqlExpressionVisitor].
 */
interface ClickhouseExpressionVisitor : SqlExpressionVisitor {
